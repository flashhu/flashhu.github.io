/*v0.5vv_20200413_syb_scopedata*/ window.__wcc_version__ =
...
$gwx = function (path, global) {
  ...
  function gz$gwx_1() {
    ...
    (function (z) {
      ...
      Z([3, "快速了解云开发"]);
      Z([3, "top_tip"]);
      Z([3, "免鉴权接口调用 免部署后台 高并发"]);
      Z([3, "power"]);
      Z([[7], [3, "powerList"]]);
      Z(z[1]);
      Z(z[5]);
      Z([3, "onClickPowerInfo"]);
      Z([3, "power_info"]);
      Z([[7], [3, "index"]]);
      Z([3, "power_info_text"]);
      Z([3, "power_info_text_title"]);
      Z([a, [[6], [[7], [3, "power"]], [3, "title"]]]);
      Z([3, "power_info_text_tip"]);
      Z([a, [[6], [[7], [3, "power"]], [3, "tip"]]]);
      Z([
        [2, "!"],
        [[6], [[7], [3, "power"]], [3, "showItem"]],
      ]);
      Z([3, "power_info_more"]);
      Z([3, "../../images/arrow.svg"]);
      Z([[6], [[7], [3, "power"]], [3, "showItem"]]);
      Z([3, "power_info_less"]);
      Z(z[19]);
      Z(z[20]);
      Z([[6], [[7], [3, "power"]], [3, "item"]]);
      Z(z[1]);
      Z([3, "line"]);
      Z([3, "jumpPage"]);
      Z([3, "power_item"]);
      Z([[6], [[7], [3, "item"]], [3, "page"]]);
      Z([3, "power_item_title"]);
      Z([a, [[6], [[7], [3, "item"]], [3, "title"]]]);
      Z([3, "power_item_icon"]);
      Z(z[19]);
      Z([3, "onChangeShowEnvChoose"]);
      Z([3, "environment"]);
      Z([a, [3, "当前环境 "], [[6], [[7], [3, "selectedEnv"]], [3, "alias"]]]);
      Z([[7], [3, "showUploadTip"]]);
    })(__WXML_GLOBAL__.ops_cached.$gwx_1);
    return __WXML_GLOBAL__.ops_cached.$gwx_1;
  }
  ...
  var m0 = function (e, s, r, gg) {
    var z = gz$gwx_1();
    cs.push("index.wxml:view:2:2");
    var oB = _n("view");
    _rz(z, oB, "class", 0, e, s, gg);
    cs.push("index.wxml:view:4:4");
    var xC = _n("view");
    ...
    var oH = function (oJ, cI, lK, gg) {
      ...
      var bO = _mz(
        z,
        "view",
        ["bindtap", 9, "class", 1, "data-index", 2],
        [],
        oJ,
        cI,
        gg
      );
      cs.push("index.wxml:view:10:8");
      var oR = _n("view");
      _rz(z, oR, "class", 12, oJ, cI, gg);
      cs.push("index.wxml:view:11:10");
      var fS = _n("view");
      _rz(z, fS, "class", 13, oJ, cI, gg);
      var cT = _oz(z, 14, oJ, cI, gg);
      _(fS, cT);
      cs.pop();
      _(oR, fS);
      cs.push("index.wxml:view:12:10");
      var hU = _n("view");
      _rz(z, hU, "class", 15, oJ, cI, gg);
      var oV = _oz(z, 16, oJ, cI, gg);
      _(hU, oV);
      cs.pop();
      _(oR, hU);
      cs.pop();
      ...
      var oP = _v();
      _(bO, oP);
      if (_oz(z, 17, oJ, cI, gg)) {
        oP.wxVkey = 1;
        cs.push("index.wxml:image:14:8");
        cs.push("index.wxml:image:14:8");
        var cW = _mz(z, "image", ["class", 18, "src", 1], [], oJ, cI, gg);
        cs.pop();
        _(oP, cW);
        cs.pop();
      }
      var xQ = _v();
      _(bO, xQ);
      if (_oz(z, 20, oJ, cI, gg)) {
        xQ.wxVkey = 1;
        cs.push("index.wxml:image:15:8");
        cs.push("index.wxml:image:15:8");
        var oX = _mz(z, "image", ["class", 21, "src", 1], [], oJ, cI, gg);
        cs.pop();
        _(xQ, oX);
        cs.pop();
      }
      ...
      var eN = _v();
      _(tM, eN);
      if (_oz(z, 23, oJ, cI, gg)) {
        eN.wxVkey = 1;
        cs.push("index.wxml:view:17:6");
        cs.push("index.wxml:view:17:6");
        var lY = _n("view");
        var aZ = _v();
        _(lY, aZ);
        cs.push("index.wxml:view:18:8");
        var t1 = function (b3, e2, o4, gg) {
          cs.push("index.wxml:view:18:8");
          var o6 = _n("view");
          cs.push("index.wxml:view:19:10");
          var f7 = _n("view");
          _rz(z, f7, "class", 26, b3, e2, gg);
          cs.pop();
          _(o6, f7);
          cs.push("index.wxml:view:20:10");
          var c8 = _mz(
            z,
            "view",
            ["bindtap", 27, "class", 1, "data-page", 2],
            [],
            b3,
            e2,
            gg
          );
          cs.push("index.wxml:view:21:12");
          var h9 = _n("view");
          _rz(z, h9, "class", 30, b3, e2, gg);
          var o0 = _oz(z, 31, b3, e2, gg);
          _(h9, o0);
          cs.pop();
          _(c8, h9);
          cs.push("index.wxml:image:22:12");
          var cAB = _mz(z, "image", ["class", 32, "src", 1], [], b3, e2, gg);
          cs.pop();
          _(c8, cAB);
          cs.pop();
          _(o6, c8);
        ...
        aZ.wxXCkey = 2;
        _2z(z, 24, t1, oJ, cI, gg, aZ, "item", "index", "title");
        cs.pop();
        cs.pop();
        _(eN, lY);
        cs.pop();
    ...
    hG.wxXCkey = 2;
    _2z(z, 6, oH, e, s, gg, hG, "power", "index", "title");
    cs.pop();
    cs.push("index.wxml:view:28:4");
    var oBB = _mz(z, "view", ["bindtap", 34, "class", 1], [], e, s, gg);
    var lCB = _oz(z, 36, e, s, gg);
    _(oBB, lCB);
    cs.pop();
    _(oB, oBB);
    cs.push("index.wxml:cloud-tip-modal:30:4");
    var aDB = _n("cloud-tip-modal");
    _rz(z, aDB, "showUploadTipProps", 37, e, s, gg);
    cs.pop();
    _(oB, aDB);
    cs.pop();
    _(r, oB);
