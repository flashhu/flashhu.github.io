...
* HTTP/2 使用“HPACK”算法**压缩头部**信息，消除冗余数据节约带宽（字典，索引，哈夫曼编码）；

* HTTP/2 的消息不再是“Header+Body”的形式，而是分散为多个**二进制“帧”**；

  > 从传输的角度来看流是不存在的，只是看到了一个个帧，所以说流是虚拟的。

* HTTP/2 使用虚拟的**“流”**传输消息，解决了困扰多年的“队头阻塞”问题，同时实现了“多路复用”（一个 TCP 连接上发送多个“碎片化”消息），提高连接的利用率；服务器可新建“流”主动向客户端发送消息，“**服务器推送**”

* HTTP/2 也增强了安全性，要求至少是 TLS1.2，而且禁用了很多不安全的密码套件。

<img src="https://static001.geekbang.org/resource/image/d8/bc/d8fd32a4d044f2078b3a260e4478c5bc.png" alt="流传输图例" style="zoom:80%;" />

<img src="https://static001.geekbang.org/resource/image/83/1a/83c9f0ecad361ba8ef8f3b73d6872f1a.png" alt="协议栈图例" style="zoom:80%;" />